...
<div align="center">
  ...
  🎨 **An immersive 3D portfolio experience showcasing my work and journey in tech**
</div>
...
- Fully explorable 3D room
- Custom-modeled assets in Blender
...
│   └── audio/        # Sound files
└── blender files/    # Original 3D source files
\`\`\`
